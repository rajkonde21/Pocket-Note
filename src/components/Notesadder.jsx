    ...
    <div className="noteaddermainbody">
      <div className="notesadder">
        <div className="notesInfolist">
          <div className="arrowback notesadders" onClick={handlearrow} ><img src={arrow} /></div>
          <div className="initials" style={{ backgroundColor: `${selectedX.y}` }}>
            {(selectedX.y).slice(0, 2).toUpperCase()}
          </div>
      ...
      <form onSubmit={handleSubmit} className="formofnotes">
        ...
        />
        <button className="notesbutton" type="submit"><img src={send}/></button>
      </form>
    </div>
  );
};
